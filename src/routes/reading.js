...
router.post('/', async (req, res) => {
  ...
  console.log(`[${FILE}] >>> STEP 5: year parsed | year=${year} currentYear=${currentYear}`);
  if (year < 1924 || year > currentYear) {
    log(5, 'Validation failed: year out of range', { year, currentYear });
    console.log(`[${FILE}] >>> STEP 5 FAIL: year out of range | year=${year} (allowed 1924–${currentYear})`);
